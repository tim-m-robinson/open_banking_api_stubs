...
public class AccountTransactionsTest {
    ...
    private final String endPoint = "open-banking/accounts/22289/transactions";
    ...
    public static WebArchive createDeployment() {
        ...
        WebArchive war = ShrinkWrap.create(WebArchive.class, "open-banking-api-test.war")
                ...
                .addAsResource("data/getAccountTransactions22289.json")
    ...
    public void should_return_data() {
        ...
        expect().
          ...
          that().body("Data.Transaction.TransactionId", notNullValue()).
        when().
          get(deploymentUrl + endPoint);
    }
