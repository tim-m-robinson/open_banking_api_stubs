...
public class AccountBalancesTest {
    ...
    private final String endPoint = "open-banking/accounts/22289/balances";
    ...
    public static WebArchive createDeployment() {
        ...
        WebArchive war = ShrinkWrap.create(WebArchive.class, "open-banking-api-test.war")
                ...
                .addAsResource("data/getAccountBalances22289.json")
    ...
    public void should_return_data() {
        ...
        expect().
          ...
          that().body("Data.Balance.Amount.Amount", notNullValue()).
        when().
          get(deploymentUrl + endPoint);
    }
