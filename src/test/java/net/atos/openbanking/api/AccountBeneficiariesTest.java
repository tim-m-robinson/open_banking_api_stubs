...
public class AccountBeneficiariesTest {

    private final String endPoint = "open-banking/accounts/22289/beneficiaries";
    ...
    public static WebArchive createDeployment() {
        ...
        WebArchive war = ShrinkWrap.create(WebArchive.class, "open-banking-api-test.war")
                ...
                .addAsResource("data/getAccountBeneficiaries22289.json")
    ...
    public void should_return_data() {
        ...
        expect().
          ...
          that().body("Data.Beneficiary.BeneficiaryId", notNullValue()).
        when().
          get(deploymentUrl + endPoint);
    }
