...
public class BulkAccountsTest {

    private final String endPoint = "open-banking/accounts";
    ...
    public void should_return_data() {
        ...
        expect().
          ...
          header("x-fapi-interaction-id", "9876-ABCD-1234-ZYXW").
          header("x-jws-signature", notNullValue()).
          body("Data.Account.AccountId", hasItems("22289","31820")).
        when().
          get(deploymentUrl + endPoint);
    }
